...
{   
	...
	//$nomeq2 = new Equipe();
	if($p!=null){
	$idequipe1 = $p->getID_Equipe();// recupere
	$idequipe2 = $p->getID_Equipe2();
	$nomeq = $dao2->find($idequipe1);//	$nomeq est un objet equipe +-recherche
	$nomeq2 = $dao2->find($idequipe2);

	if (($p!=null)&&($nomeq!=null)&&($nomeq2!=null)) // si  il trouve objet match + trouve les deux equipe
	{
